...
typedef int (*lib_function) (int len, const char *data); //this func pointer matches  the singnature of every func in libex29_ec
...
int main(int argc, char *argv[]) {
    ...
    char *data = argv[3];
    int data_len = strlen(data); //still not the safest
    ...
    rc = func(data_len, data); //we than call this function and pass it the data
